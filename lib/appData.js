...
import { getAllMatches, getMeta, getCredits, initSchema } from "./db.js";
...
/**
 * @returns {Promise<{matches, scorecard, meta, credits, empty, error?}>}
 */
export async function loadAppData() {
  try {
    ...
    return { matches, scorecard, meta, credits, empty: matches.length === 0 };
  } catch {
    return {
      matches: [],
